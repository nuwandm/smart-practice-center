...
const partnerLogos = [
  ...
  {
    src: `${BASE}/partnerlogo/MasterCard_Logo.svg.png`,
    alt: "Mastercard",
    width: 72,
  },
...
const integrations = [
  ...
  },
  {
    ...
    description:
      "Full Sri Lankan Rupee support with Visa & Mastercard billing.",
    icon: CreditCard,
  ...
  },
  {
    ...
    description:
      "RESTful API for connecting with your existing hospital systems.",
    icon: Code2,
  ...
  },
  {
    ...
    description:
      "End-to-end encryption compliant with Sri Lankan health data laws.",
    icon: ShieldCheck,
    color: "text-rose-400",
    bg: "bg-rose-400/10",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-slate-400">
            Built with open standards and local partnerships for seamless
        ...
        >
          {integrations.map((item) => {
            ...
            return (
              ...
              >
                <div
                  className={`shrink-0 w-11 h-11 rounded-xl flex items-center justify-center ${item.bg} transition-transform duration-300 group-hover:scale-110`}
                >
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span
                      className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${item.bg} ${item.color} uppercase tracking-wider`}
                    >
                      {item.category}
                    </span>
                  </div>
